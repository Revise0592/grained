...
import { Film, KeyRound, Lock } from 'lucide-react'
    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-semibold text-foreground tracking-tight">Reset admin password</h1>
          <p className="text-sm text-muted-foreground mt-1">Use the one-time reset token generated by the server.</p>
        </div>
